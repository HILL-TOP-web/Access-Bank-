...
app.post("/webhook", async (req, res) => {
  try {
    const signature = req.headers["x-paystack-signature"]; // if Paystack
    const hash = crypto
    ...
    // Example: Successful payment credit
...
app.locals = {
  ...
  WEBHOOK_URL: process.env.WEBHOOK_URL // ✅ Exposed webhook URL
};
